...
type SourceInfo struct {
	...
	//    e.g. "github.com/mcspring/revel/samples/chat/app/controllers.(*Application).Action"
...
type TypeInfo struct {
	...
	ImportPath  string // e.g. "github.com/mcspring/revel/samples/chat/app/controllers"
...
// e.g. "github.com/mcspring/revel.Controller"
